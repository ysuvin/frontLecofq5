...
export default function ModificarPacienteF() {
    ...
    const peticionGet = (id) => {
        Axios.get(`http://api.lecofq.informatica.uv.cl//fichaPaciente/${id}`).then(response => {
            ...
            setComuna(response.data.data.comuna);
            setEstado_civil(response.data.data.estado_civil);
            setPrevision(response.data.data.prevision);
            setMotivo_consulta(response.data.data.motivo_consulta);
            setTelefono(response.data.data.telefono);
            setFecha_ingreso(response.data.data.fecha_ingreso);
                ...
                <form className={classes.form} noValidate >
                    <Grid container spacing={3}>
                        <Grid item xs={12} md={6}>
                            <TextField disable type="number" id="rutPaci" label="Rut (Ej: 12345678-9)" fullWidth autoComplete="rut-paci"
                        ...
                        <Grid item xs={12} md={6}>
                            <TextField id="domici" label="Domicilio" fullWidth autoComplete="domici"
                            ...
                            <div>
                                {
                                    ...
                                    <Snackbar open={open} autoHideDuration={6000} onClose={handleClose}>
                                        ...
                                        La ficha se ha modificado con exito!
                                        </Alert>
                                     </Snackbar>
                                :
                                    <Snackbar open={open} autoHideDuration={6000} onClose={handleClose}>
